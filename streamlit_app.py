...
with tab_learn:
    ...
    st.markdown(
        ...
        "range. Quarterback passing yards are the weak spot: correlation +0.07, "
        "barely matching the trivial baseline of a passer's own prior yards per game "
        "(+0.18), which is why longshots are not offered on that market.\n\n"
